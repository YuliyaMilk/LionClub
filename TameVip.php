...
<html lang="en">
 ...
 <div class="container">
    ...
    <div class="ticket wow zoomInRight"> 
        ...
        <div class="textTick"> <p> <h2> Tame Impala</h2><br/> Дата: 20 января 2019г. <br/> Время: 20:00 <br/> Тип билета: VIP <br/> Пользователь: <?php echo $_SESSION['logged_user'] ->login; ?> </p> </div>
    </div>
    </body>
    </html>
