...
<html lang="en">
 ...
 <div class="container">
    ...
    <div class="ticket wow zoomInRight"> 
        ...
        <div class="textTick"> <p> <h2> Metallica</h2><br/> Дата: 19 декабря 2019г. <br/> Время: 19:00 <br/> Тип билета: VIP <br/> Пользователь: <?php echo $_SESSION['logged_user'] ->login; ?> </p> </div>
    </div>
    </body>
    </html>
