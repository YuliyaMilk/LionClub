...
<html lang="en">
 ...
 <div class="container">
    ...
    <div class="ticket wow zoomInRight"> 
        <img class="imgg" src="Tame_Impala.jpg" width="355" height="233">
        <div class="textTick"> <p> <h2> Tame Impala</h2><br/> Дата: 20 января 2019г. <br/> Время: 20:00 <br/> Тип билета: VIP(COMFORT+) <br/> Пользователь: <?php echo $_SESSION['logged_user'] ->login; ?> </p> </div>
    </div>
    </body>
    </html>
