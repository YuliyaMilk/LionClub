...
<html lang="en">
 ...
 <div class="container">
    ...
    <div class="ticket wow zoomInRight"> 
        <img class="imgg" src="Metallica.jpg" width="355" height="233">
        <div class="textTick"> <p> <h2> Metallica</h2><br/> Дата: 19 декабря 2019г. <br/> Время: 19:00 <br/> Тип билета: VIP(COMFORT+) <br/> Пользователь: <?php echo $_SESSION['logged_user'] ->login; ?> </p> </div>
    </div>
    </body>
    </html>
