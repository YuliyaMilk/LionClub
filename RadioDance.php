...
<html lang="en">
 ...
 <div class="container">
    ...
    <div class="ticket wow zoomInRight"> 
        ...
        <div class="textTick"> <p> <h2> Radiohead</h2><br/> Дата: 21 февраля 2019г. <br/> Время: 19:00 <br/> Тип билета: ТАНЦПОЛ <br/> Пользователь: <?php echo $_SESSION['logged_user'] ->login; ?> </p> </div>
    </div>
    </body>
    </html>
